...
<head>
    <meta charset="UTF-8"/>
    <title>Sarbatra Travel Cms - Ultimate Booking System</title>
            ...
            <div class="row">
                <div class="col-xs-3">
                    <h1><a target="_blank" href="{{url('intro')}}"><img src="{{url('images')}}/logo.svg"
                                                                 alt="Sarbatra Travel Cms Logo"/></a></h1>
                </div>
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://sarbatra.com" target="_blank">Support</a>
                            <a target="_blank" class="dropdown-item" href="https://sarbatra.com">Documentation</a>
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a target="_blank" href="https://sarbatra.com">Support</a>
                        </li>
                        <li>
                            <a target="_blank" href="https://sarbatra.com">Documentation</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Sarbatra Travel Cms</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
        <a target="_blank"  href="{{config('landing.item_url')}}" class="btn-buynow">BUY NOW</a>
        <div class="social">
            <span>FOLLOW US</span>
            <ul>
                <li><a target="_blank" href="https://www.facebook.com/sarbatrainc/"><svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="mailto:info@sarbatra.com">
