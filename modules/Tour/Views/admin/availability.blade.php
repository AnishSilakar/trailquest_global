        ...
        formModal = new Vue({
                ...
                show:function (form) {
                    ...
                    if(typeof form !='undefined'){
                        ...
                        if(form.start_date){
                            ...
                            drp.setStartDate(moment(form.start_date).format(sarbatraCMSUrl.date_format));
                            drp.setEndDate(moment(form.end_date).format(sarbatraCMSUrl.date_format));
                        }
                    }
                },
                hide:function () {
            ...
            created:function () {
                ...
                this.$nextTick(function () {
                    $('.has-daterangepicker').daterangepicker({ "locale": {"format": sarbatraCMSUrl.date_format}})
