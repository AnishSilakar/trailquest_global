                ...
                <div class="item" data-number="{{$key}}">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="itinerary[{{$key}}][hiking]" class="form-control" value="{{$itinerary['hiking'] ?? ""}}" placeholder="{{__('Hiking')}}">
                            <input type="text" name="itinerary[{{$key}}][accomodation]" class="form-control" value="{{$itinerary['accomodation'] ?? ""}}" placeholder="{{__('Accomodation: TP. Bus')}}">
                        </div>
                        <div class="col-md-5">
                            <textarea name="itinerary[{{$key}}][content]"  class="d-none has-ckeditor" placeholder="...">{{$itinerary['content']}}</textarea>
                        </div>
                        <div class="col-md-1">
