                                ...
                                <div class="col-md-4 d-none">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Updater Sarbatra Travel CMS")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Plugins for Sarbatra Travel CMS")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Clear Cache for Sarbatra Travel CMS")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
