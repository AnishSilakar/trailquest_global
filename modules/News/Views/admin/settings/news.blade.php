<div class="row">
 ...
 <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="text" name="news_page_list_desc" value="{{setting_item_with_lang('news_page_list_desc',request()->query('lang'),$settings['news_page_list_desc'] ?? '')}}" class="form-control">
                    </div>
                </div>
