...
@push('js')
    ...
    <script type="text/javascript">
        jQuery(function () {
            $.ajax({
                'url': sarbatraCMSUrl.url + '{{$is_api ? '/api' : ''}}/booking/{{$booking->code}}/check-status',
                'cache': false,
                'type': 'GET',
        ...
        jQuery(function () {
            $(".bravo_apply_coupon").click(function () {
                ...
                $.ajax({
                    'url': sarbatraCMSUrl.url + '/booking/{{$booking->code}}/apply-coupon',
            ...
            $(".bravo_remove_coupon").click(function (e) {
                ...
                $.ajax({
                    'url': sarbatraCMSUrl.url + '/booking/{{$booking->code}}/remove-coupon',
                    'data': {
