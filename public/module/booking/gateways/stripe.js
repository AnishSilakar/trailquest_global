jQuery(document).ready(function ($) {
    'use strict';
    var stripePublishKey = sarbatraCMSUrl_gateways_stripe.stripe_publishable_key;
    if (sarbatraCMSUrl_gateways_stripe.stripe_enable_sandbox === "1") {
        stripePublishKey = sarbatraCMSUrl_gateways_stripe.stripe_test_publishable_key;
    }
    if (stripePublishKey === '') {
        return false;
    }
