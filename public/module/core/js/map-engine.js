(function ($) {
    window.BravoMapEngine = function (id,configs) {
        switch (sarbatraCMSUrl.map_provider) {
            case "osm":
    ...
    OsmMapEngine.prototype.initScripts = function (func) {
        ...
        script.src= sarbatraCMSUrl.url_root+'/libs/leaflet1.4.0/leaflet.js';
        head.appendChild(script);

        var link = document.createElement('link');
        link.rel = 'stylesheet';
        link.href = sarbatraCMSUrl.url_root+'/libs/leaflet1.4.0/leaflet.css';
    ...
    OsmMapEngine.prototype.addMarker = function (latLng,options) {
        ...
        //     options.icon_options.iconUrl = sarbatraCMSUrl.url+'/images/favicon.png';
        // }
    ...
    GmapEngine.prototype.initScripts = function (func) {
        ...
        var script= document.createElement('script');
        script.type= 'text/javascript';
        script.src= 'https://maps.googleapis.com/maps/api/js?key='+sarbatraCMSUrl.map_gmap_key+'&libraries=places';
        head.appendChild(script);

		var script2 = document.createElement('script');
		script2.type= 'text/javascript';
		script2.src= sarbatraCMSUrl.url+'/libs/infobox.js';
