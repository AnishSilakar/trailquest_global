    ...
    var hotelRoomForm = new Vue({
        ...
        mounted(){
            ...
            var options = {
                ...
                autoApply           : true,
                disabledPast        : true,
                dateFormat          : sarbatraCMSUrl.date_format,
                enableLoading       : true,
                showEventTooltip    : true,
                classNotAvailable   : ['disabled', 'off'],
                disableHightLight: true,
                minDate:this.minDate,
                opens: sarbatraCMSUrl.rtl ? 'left':'right',
                locale:{
            ...
            this.$nextTick(function () {
                $(this.$refs.start_date).daterangepicker(options).on('apply.daterangepicker',
                    function (ev, picker) {
                        ...
                        me.start_date_html = picker.startDate.format(sarbatraCMSUrl.date_format) +' <i class="fa fa-long-arrow-right" style="font-size: inherit"></i> '+ picker.endDate.format(sarbatraCMSUrl.date_format);
                        // me.handleTotalPrice();
                    })
            })
        },
        methods:{
			...
			checkAvailability:function () {
                ...
                if(!this.firstLoad){
                    if(!this.start_date || !this.start_date){
                        sarbatraCMSUrlApp.showError(this.i18n.date_required);
                        return;
                    }
                }
                this.onLoadAvailability = true;
                $.ajax({
                    url:sarbatraCMSUrl.module.hotel+'/checkAvailability',
                    data:{
                        hotel_id:this.id,
                    ...
                    success:function (json) {
                        ...
                        if(json.message){
                            sarbatraCMSUrlApp.showAjaxMessage(json);
                        }
                    },
                    error:function (e) {
                        me.firstLoad = false;
            ...
            doSubmit:function (e) {
                ...
                $.ajax({
                    url:sarbatraCMSUrl.url+'/booking/addToCart',
                    data:{
                        service_id:this.id,
                        service_type:"hotel",
                        start_date:this.start_date,
                    ...
                    success:function(res){
                        ...
                        if(res.message){
                            sarbatraCMSUrlApp.showAjaxMessage(res);
                        }
                        ...
                        if(res.errors && typeof res.errors == 'object')
                        {
                            ...
                            sarbatraCMSUrlApp.showError(html);
                        }
                    },
                    error:function (e) {
                        console.log(e);
