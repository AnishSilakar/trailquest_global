    ...
    $(document).on('click', '.dungdt-upload-box-normal .edit-img, .dungdt-upload-multiple .edit-img, .show_avatar .edit-img', function (e) {
        ...
        let callback = {
            ...
            onComplete: function (url){
                ...
                $.ajax({
                    url: sarbatraCMSUrl.url + '/media/edit_image',
                    method: 'POST',
                    dataType: 'JSON',
                    data:{
                        image: canvas,
            ...
            file_picker_callback: function (callback, value, meta) {
                ...
                if (meta.filetype === 'file') {
                    uploaderModal.show({
                        ...
                        onSelect:function (files) {
                            if(files.length)
                                callback(sarbatraCMSUrl.url+'/media/preview/'+files[0].id);
                        },
                    });
                }
...
var vendorPayout = {
    saveAccounts:function (btn) {
        ...
        $.ajax({
            url:sarbatraCMSUrl.url+'/vendor/storePayoutAccounts',
            method:"post",
            ...
            success:function (json) {
                ...
                if(json.message){
                    sarbatraCMSUrlApp.showSuccess(json.message);
                }
                if(json.status){
    ...
    sendRequest:function (btn) {
        ...
        $.ajax({
            url:sarbatraCMSUrl.url+'/vendor/createPayoutRequest',
            method:"post",
