function yourTrailquestReloadForm(url = ''){
...
$(document).on('click','.yourTrailquest-bravo-pagination a',function (e) {
    e.preventDefault();
    yourTrailquestReloadForm($(this).attr('href'));
})
