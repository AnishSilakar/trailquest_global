...
//Login
$('.bravo-theme-yourtrailquest-login-form [type=submit]').on("click", function (e) {
    e.preventDefault();
    let form = $(this).closest('.bravo-theme-yourtrailquest-login-form');
...
$(document).ready(function () {
    ...
    $(".yourtrailquest-dropdown .menu-item-has-children > a").on("click", function (e) {
        e.preventDefault();
        let p = $(this).parent();
        $(".yourtrailquest-dropdown .menu-item-has-children").not(p).removeClass("show");
        p.toggleClass("show");
    })
