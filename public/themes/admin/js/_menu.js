    ...
    new Vue({
        ...
        methods: {
            ...
            searchItems(type) {
                // if(!type.q) return;
                $.ajax({
                    url: sarbatraCMSUrl.admin_url + '/module/core/menu/searchTypeItems',
                    data: {
                        class: type.class,
                        q: type.q
                    },
            ...
            reloadItems() {
                var me = this;
                $.ajax({
                    url: sarbatraCMSUrl.admin_url + '/module/core/menu/getItems',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        id: menu_id
            ...
            reloadTypes() {
                var me = this;
                $.ajax({
                    url: sarbatraCMSUrl.admin_url + '/module/core/menu/getTypes',
                    dataType: 'json',
                    type: 'post',
                    data: {},
                    success: function (res) {
            ...
            saveMenu() {
                ...
                $.ajax({
                    url: sarbatraCMSUrl.admin_url + '/module/core/menu/store',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        id: menu_id,
