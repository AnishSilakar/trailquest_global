jQuery(function ($) {
    ...
    if (sarbatraCMSUrl_gateways_twocheckout.twocheckout_publishable_key === '') {
        console.log("TwoCheckout: Publishable not found");
        return false;
    }

    //TCO.loadPubKey(sarbatraCMSUrl_gateways_twocheckout.twocheckout_publishable_key);
    ...
    var tokenRequest = function () {
        ...
        var args = {
            sellerId: sarbatraCMSUrl_gateways_twocheckout.twocheckout_account_number,
            publishableKey: sarbatraCMSUrl_gateways_twocheckout.twocheckout_publishable_key,
            ccNo: card_number,
            cvv: card_cvc,
