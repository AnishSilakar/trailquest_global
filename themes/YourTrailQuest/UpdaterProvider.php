...
class UpdaterProvider extends ServiceProvider
{
    ...
    public function runUpdateTo100(){
        $version = '1.0.0';
        if (version_compare(setting_item('YourTrailQuest_update_to_100'), $version, '>=')) return;
        ...
        setting_update_item('YourTrailQuest_update_to_100',$version);
        Artisan::call('view:clear');
        Artisan::call('cache:clear');
    }
    public function runUpdateTo120(){
        $version = '1.0.0';
        if (version_compare(setting_item('YourTrailQuest_update_to_120'), $version, '>=')) return;
        Artisan::call('migrate', [
            '--force' => true,
        ]);
        setting_update_item('YourTrailQuest_update_to_120',$version);
        Artisan::call('cache:clear');
