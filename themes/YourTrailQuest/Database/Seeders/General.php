<?php
namespace Themes\YourTrailQuest\Database\Seeders;
...
class General extends  Seeder
{
    ...
    {
        $logo = [
            'light' => DB::table('media_files')->insertGetId(['file_name' => 'logo-light', 'file_path' => 'yourtrailquest/general/logo-light.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'dark' => DB::table('media_files')->insertGetId(['file_name' => 'logo-dark', 'file_path' => 'yourtrailquest/general/logo-dark.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'preload' => DB::table('media_files')->insertGetId(['file_name' => 'preload', 'file_path' => 'yourtrailquest/general/preload.svg', 'file_type' => 'image/svg', 'file_extension' => 'svg']),
        ];

        //Mega menu image
        DB::table('media_files')->insertGetId(['file_name' => 'mega-menu-bg', 'file_path' => 'yourtrailquest/general/mega-menu-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']);
        ...
        DB::table('core_settings')->insert(
            [
                ...
                [
                    'name' => 'admin_email',
                    'val' => 'contact@yourtrailquest.test',
                    'group' => "general",
                ],
                [
                    'name' => 'email_from_name',
                    'val' => 'Your Trail Quest',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => 'Copyright © 2023 by Your Trail Quest',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val'   => '[{"title":"Address","content":"328 Queensberry Street, North Melbourne VIC 3051, Australia."},{"title":"Toll Free Customer Care","content":"+(1) 123 456 7890"},{"title":"Need live support?","content":"hi@yourtrailquest.com"},{"title":"Follow us on social media","content":"<a href=\"#\"><i class=\"icon-facebook text-14\"><\/i><\/a>\r\n<a href=\"#\"><i class=\"icon-twitter text-14\"><\/i><\/a>\r\n<a href=\"#\"><i class=\"icon-instagram text-14\"><\/i><\/a>\r\n<a href=\"#\"><i class=\"icon-linkedin text-14\"><\/i><\/a>"}]',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>Your Trail Quest</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
        ...
        DB::table('core_settings')->insert([
            ...
            [
                ...
                'val' => '<div class="row x-gap-15 y-gap-15 items-center">
                              ...
                              <div class="col-auto">
                                <a href="#" class="text-12 text-white">hi@yourtrailquest.com</a>
                              </div>
                         </div>',
                'group' => "general"
            ],
        ...
        DB::table('core_settings')->insert([
            ...
            [
                'name' => "email_header",
                'val' => '<h1 class="site-title" style="text-align: center">Your Trail Quest</h1>',
                'group' => "general",
            ],
            [
                'name' => "email_footer",
                'val' => '<p class="" style="text-align: center">&copy; 2023 Your Trail Quest. All rights reserved</p>',
                'group' => "general",
            ],
            [
            ...
            [
                ...
                'val' => '<h1 style="text-align: center">Welcome!</h1>
                    ...
                    <p>Thank you for signing up with Your Trail Quest! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Your Trail Quest</p>',
                'group' => "user",
            ],
            [
        ...
        DB::table('core_settings')->insert([
            ...
            [
                ...
                'val' => "<p><span style=\"font-size: 14pt;\"><strong>Your Trail Quest Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
                                <p>www.yourtrailquest.org</p>",
                'group' => "booking",
            ],
        ]);
        ...
        // Setting Home Page
        $home1_image = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'home1-bg', 'file_path' => 'yourtrailquest/general/home1-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'offer-1', 'file_path' => 'yourtrailquest/general/offer-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_3' => DB::table('media_files')->insertGetId(['file_name' => 'offer-2', 'file_path' => 'yourtrailquest/general/offer-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_4' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-1', 'file_path' => 'yourtrailquest/general/feature-item-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_5' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-2', 'file_path' => 'yourtrailquest/general/feature-item-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_6' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-3', 'file_path' => 'yourtrailquest/general/feature-item-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_7' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-1', 'file_path' => 'yourtrailquest/general/avatar-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        $home1 = [
            [
        ...
        // Setting Home Page
        $home2_image = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'home2-bg', 'file_path' => 'yourtrailquest/general/home2-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),

            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'home2-slider-1', 'file_path' => 'yourtrailquest/general/home2-slider-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_3' => DB::table('media_files')->insertGetId(['file_name' => 'home2-slider-2', 'file_path' => 'yourtrailquest/general/home2-slider-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_4' => DB::table('media_files')->insertGetId(['file_name' => 'home2-slider-3', 'file_path' => 'yourtrailquest/general/home2-slider-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),

            'img_8' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-1', 'file_path' => 'yourtrailquest/general/avatar-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),

            'img_9' => DB::table('media_files')->insertGetId(['file_name' => 'trusted-1', 'file_path' => 'yourtrailquest/general/trusted-1.svg', 'file_type' => 'image/svg+xml', 'file_extension' => 'svg']),
            'img_10' => DB::table('media_files')->insertGetId(['file_name' => 'trusted-2', 'file_path' => 'yourtrailquest/general/trusted-2.svg', 'file_type' => 'image/svg+xml', 'file_extension' => 'svg']),
            'img_11' => DB::table('media_files')->insertGetId(['file_name' => 'trusted-3', 'file_path' => 'yourtrailquest/general/trusted-3.svg', 'file_type' => 'image/svg+xml', 'file_extension' => 'svg']),
            'img_12' => DB::table('media_files')->insertGetId(['file_name' => 'trusted-4', 'file_path' => 'yourtrailquest/general/trusted-4.svg', 'file_type' => 'image/svg+xml', 'file_extension' => 'svg']),
            'img_13' => DB::table('media_files')->insertGetId(['file_name' => 'trusted-5', 'file_path' => 'yourtrailquest/general/trusted-5.svg', 'file_type' => 'image/svg+xml', 'file_extension' => 'svg']),
            'img_14' => DB::table('media_files')->insertGetId(['file_name' => 'trusted-6', 'file_path' => 'yourtrailquest/general/trusted-6.svg', 'file_type' => 'image/svg+xml', 'file_extension' => 'svg']),

            'img_15' => DB::table('media_files')->insertGetId(['file_name' => 'subscribe', 'file_path' => 'yourtrailquest/general/subscribe.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_16' => DB::table('media_files')->insertGetId(['file_name' => 'download_app', 'file_path' => 'yourtrailquest/general/download_app.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        // home 2
        $home2 = [
            [
            ...
            [
                ...
                "model" => [
                    ...
                    "sub_title" => "Book in advance or last-minute with YourTrailQuest. Receive instant confirmation. Access your booking info offline.",
        ...
        $home4_image = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'home4-bg', 'file_path' => 'yourtrailquest/general/home4-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'call-to-action-home4', 'file_path' => 'yourtrailquest/general/call-to-action-home4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        $home4 = [
            [
            ...
            [
                ...
                "name" => "Hotel: List Items",
                "model" => [
                    "title" => "YourTrailQuest Choice of Hotels",
                    "desc" => "Interdum et malesuada fames ac ante ipsum",
                    "number" => 4,
                    "style" => "carousel_v2",
                    "location_ids" => [],
        ...
        $home5_image = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'home5-bg', 'file_path' => 'yourtrailquest/general/home5/1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'call-to-action-home5', 'file_path' => 'yourtrailquest/general/home5/5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_3' => DB::table('media_files')->insertGetId(['file_name' => 'home5-tour-deals', 'file_path' => 'yourtrailquest/general/home5/6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_4' => DB::table('media_files')->insertGetId(['file_name' => 'avt-1', 'file_path' => 'yourtrailquest/general/home5/avt-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_5' => DB::table('media_files')->insertGetId(['file_name' => 'avt-2', 'file_path' => 'yourtrailquest/general/home5/avt-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_6' => DB::table('media_files')->insertGetId(['file_name' => 'avt-3', 'file_path' => 'yourtrailquest/general/home5/avt-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_7' => DB::table('media_files')->insertGetId(['file_name' => 'avt-4', 'file_path' => 'yourtrailquest/general/home5/avt-4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_8' => DB::table('media_files')->insertGetId(['file_name' => 'avt-5', 'file_path' => 'yourtrailquest/general/home5/avt-5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_9' => DB::table('media_files')->insertGetId(['file_name' => 'avt-bg', 'file_path' => 'yourtrailquest/general/home5/bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        ...
        $home7_image = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'home7-bg', 'file_path' => 'yourtrailquest/general/home7/bg-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'testimonial-home7', 'file_path' => 'yourtrailquest/general/home7/testimonial-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_3' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-home7', 'file_path' => 'yourtrailquest/general/home7/avatar-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_4' => DB::table('media_files')->insertGetId(['file_name' => 'subscribe-home7', 'file_path' => 'yourtrailquest/general/home7/subscribe-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        ...
        $home_car_images = [
            'hero_slider' => DB::table('media_files')->insertGetId(['file_name' => 'hero-slider', 'file_path' => 'yourtrailquest/general/home6/hero-slider.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'hero_bg' => DB::table('media_files')->insertGetId(['file_name' => 'hero-bg', 'file_path' => 'yourtrailquest/general/home6/hero-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'feature_item_4' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-4', 'file_path' => 'yourtrailquest/general/home6/feature-item-4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'feature_item_5' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-5', 'file_path' => 'yourtrailquest/general/home6/feature-item-5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'feature_item_6' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-6', 'file_path' => 'yourtrailquest/general/home6/feature-item-6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'amazon' => DB::table('media_files')->insertGetId(['file_name' => 'amazon', 'file_path' => 'yourtrailquest/general/home6/amazon.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'amd' => DB::table('media_files')->insertGetId(['file_name' => 'amd', 'file_path' => 'yourtrailquest/general/home6/amd.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'cisco' => DB::table('media_files')->insertGetId(['file_name' => 'cisco', 'file_path' => 'yourtrailquest/general/home6/cisco.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'dropcam' => DB::table('media_files')->insertGetId(['file_name' => 'dropcam', 'file_path' => 'yourtrailquest/general/home6/dropcam.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'download_app' => DB::table('media_files')->insertGetId(['file_name' => 'download-app', 'file_path' => 'yourtrailquest/general/home6/download-app.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        ...
        $home_car = [
            ...
            [
                ...
                'model' => [
                    'title' => 'YourTrailQuest is a World Leading Car Hire Booking Platform',
        ...
        //Home Boat
        $home_boat_images = [
            'boat_hero_bg' => DB::table('media_files')->insertGetId(['file_name' => 'boat-hero-bg', 'file_path' => 'yourtrailquest/general/home-boat/boat-hero-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_text_image_1' => DB::table('media_files')->insertGetId(['file_name' => 'boat-text-image-1', 'file_path' => 'yourtrailquest/general/home-boat/boat-text-image-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_text_image_2' => DB::table('media_files')->insertGetId(['file_name' => 'boat-text-image-2', 'file_path' => 'yourtrailquest/general/home-boat/boat-text-image-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_why_1' => DB::table('media_files')->insertGetId(['file_name' => 'boat-why-1', 'file_path' => 'yourtrailquest/general/home-boat/boat-why-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_why_2' => DB::table('media_files')->insertGetId(['file_name' => 'boat-why-2', 'file_path' => 'yourtrailquest/general/home-boat/boat-why-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_why_3' => DB::table('media_files')->insertGetId(['file_name' => 'boat-why-3', 'file_path' => 'yourtrailquest/general/home-boat/boat-why-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_why_4' => DB::table('media_files')->insertGetId(['file_name' => 'boat-why-4', 'file_path' => 'yourtrailquest/general/home-boat/boat-why-4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_quote_2' => DB::table('media_files')->insertGetId(['file_name' => 'boat-quote-2', 'file_path' => 'yourtrailquest/general/home-boat/boat-quote-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'boat_testimonial_bg' => DB::table('media_files')->insertGetId(['file_name' => 'boat-testimonial-bg', 'file_path' => 'yourtrailquest/general/home-boat/boat-testimonial-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        $home_boat = [
            [
            ...
            [
                ...
                "name" => "Text Image",
                "model" => [
                    "title" => "YourTrailQuest is a World Leading Cruise Booking Platform",
                    "desc" => "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.",
                    "link_title" => "Learn More",
        ...
        $home10_images = [
            'flight_1' => DB::table('media_files')->insertGetId(['file_name' => 'flight-1', 'file_path' => 'yourtrailquest/general/home10/flight-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'flight_2' => DB::table('media_files')->insertGetId(['file_name' => 'flight-2', 'file_path' => 'yourtrailquest/general/home10/flight-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        ...
        $home3_images = [
            'home3_bg' => DB::table('media_files')->insertGetId(['file_name' => 'home3-bg', 'file_path' => 'yourtrailquest/general/home3-bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'offer_3'  => DB::table('media_files')->insertGetId(['file_name' => 'offer-3', 'file_path' => 'yourtrailquest/general/offer-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'localtion_6'  => DB::table('media_files')->insertGetId(['file_name' => 'localtion-6', 'file_path' => 'yourtrailquest/location/6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        ...
        //Become An Expert
        $page_become_image = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'become-call-to-action', 'file_path' => 'yourtrailquest/general/become-call-to-action.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'become-youtube', 'file_path' => 'yourtrailquest/general/become-youtube.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_3' => DB::table('media_files')->insertGetId(['file_name' => 'become-icon-1', 'file_path' => 'yourtrailquest/general/become-icon-1.svg', 'file_type' => 'image/svg', 'file_extension' => 'svg']),
            'img_4' => DB::table('media_files')->insertGetId(['file_name' => 'become-icon-2', 'file_path' => 'yourtrailquest/general/become-icon-2.svg', 'file_type' => 'image/svg', 'file_extension' => 'svg']),
            'img_5' => DB::table('media_files')->insertGetId(['file_name' => 'become-icon-3', 'file_path' => 'yourtrailquest/general/become-icon-3.svg', 'file_type' => 'image/svg', 'file_extension' => 'svg']),
        ];
        $page_become_vendor = [
            [
                'type' => 'call_to_action',
        ...
        $image_map = DB::table('media_files')->insertGetId(['file_name' => 'icon-map', 'file_path' => 'yourtrailquest/general/icon-map.png', 'file_type' => 'image/png', 'file_extension' => 'png']);
        DB::table('core_settings')->insert([
            [
        ...
        //homepage6
        $home_event_images = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'home-event-bg', 'file_path' => 'yourtrailquest/general/home-event/bg.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-1', 'file_path' => 'yourtrailquest/general/home-event/ft-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_3' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-2', 'file_path' => 'yourtrailquest/general/home-event/ft-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_4' => DB::table('media_files')->insertGetId(['file_name' => 'feature-item-3', 'file_path' => 'yourtrailquest/general/home-event/ft-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_5' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-1', 'file_path' => 'yourtrailquest/general/home-event/avatar-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_6' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-2', 'file_path' => 'yourtrailquest/general/home-event/avatar-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_7' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-3', 'file_path' => 'yourtrailquest/general/home-event/avatar-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_8' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-4', 'file_path' => 'yourtrailquest/general/home-event/avatar-4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_9' => DB::table('media_files')->insertGetId(['file_name' => 'avatar-5', 'file_path' => 'yourtrailquest/general/home-event/avatar-5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_10' => DB::table('media_files')->insertGetId(['file_name' => 'download-app', 'file_path' => 'yourtrailquest/general/home-event/2-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        $home_event = [
            [
    ...
    public function generalMenu($locale = ''){
        return  array(
            ...
            array(
                ...
                'mega_menu'  => true,
                'mega_columns' => '4',
                'mega_image_url' => '/uploads/yourtrailquest/general/mega-menu-bg.png',
                'children'   => array(
                    array(
                        'name'       => 'Hotel',
                        'url'        => $locale.'/hotel',
