...
class News extends \Database\Seeders\News
{
    ...
    public function run()
    {
        ...
        $news_image = [
            'img_1' => DB::table('media_files')->insertGetId(['file_name' => 'news-1', 'file_path' => 'yourtrailquest/news/news-1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_2' => DB::table('media_files')->insertGetId(['file_name' => 'news-2', 'file_path' => 'yourtrailquest/news/news-2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_3' => DB::table('media_files')->insertGetId(['file_name' => 'news-3', 'file_path' => 'yourtrailquest/news/news-3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            'img_4' => DB::table('media_files')->insertGetId(['file_name' => 'news-4', 'file_path' => 'yourtrailquest/news/news-4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
