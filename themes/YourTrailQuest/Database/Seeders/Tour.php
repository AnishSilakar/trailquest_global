...
class Tour extends Seeder
{
    ...
    public function run()
    {
        ...
        $list_images = [
            DB::table('media_files')->insertGetId(['file_name' => 'tour-1', 'file_path' => 'yourtrailquest/tour/1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-2', 'file_path' => 'yourtrailquest/tour/2.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-3', 'file_path' => 'yourtrailquest/tour/3.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-4', 'file_path' => 'yourtrailquest/tour/4.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-5', 'file_path' => 'yourtrailquest/tour/5.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-6', 'file_path' => 'yourtrailquest/tour/6.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-7', 'file_path' => 'yourtrailquest/tour/7.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-8', 'file_path' => 'yourtrailquest/tour/8.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
            DB::table('media_files')->insertGetId(['file_name' => 'tour-9', 'file_path' => 'yourtrailquest/tour/9.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
        $list_itinerary = [
            DB::table('media_files')->insertGetId(['file_name' => 'itinerary-1', 'file_path' => 'yourtrailquest/tour/itinerary/1.png', 'file_type' => 'image/png', 'file_extension' => 'png']),
        ];
