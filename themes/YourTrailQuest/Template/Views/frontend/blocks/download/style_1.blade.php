<section data-anim-wrap class="section-bg layout-pt-32 download-app {{ $style ?? '' }}">
    <div class="container">
        <div class="row y-gap-30 items-center justify-between">
        @switch($imageposition ?? '')
        @case('left_align')

        <div data-anim-child="slide-up delay-3" class="col-lg-6 col-left ">
 ...
 @break
            @default
            <div data-anim-child="slide-up delay-2" class="col-xl-5 col-lg-6 col-right">
                <h2 class="text-30 lh-15">{{ $title ?? '' }}</h2>
                <p class="text-dark-1 pr-40 lg:pr-0 mt-15 sm:mt-5">{{ $sub_title ?? '' }}</p>
