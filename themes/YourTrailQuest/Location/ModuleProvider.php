<?php
namespace Themes\YourTrailQuest\Location;
...
use Themes\YourTrailQuest\Location\Blocks\ListLocations;
...
class ModuleProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(Location::class,\Themes\YourTrailQuest\Location\Models\Location::class);
    ...
    public function save_location_extra_info(Location $location,Request $request){
        if($request->input('yourtrailquest_save_extra'))
        {
