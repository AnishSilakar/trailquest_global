...
$mailchimp_classes = "bg-dark-tq";
$button_classes = "bg-gold text-white";
        ...
        <div class="row y-gap-30 justify-between items-center">
            <div class="col-auto">
                <div class="row y-gap-20  flex-wrap items-center">
                    <div class="col-auto">
                        <div class="icon-newsletter text-60 md:text-50 sm:text-40 text-white"></div>
                    </div>

                    <div class="col-auto">
                        <h4 class="text-26 sm:text-20 text-white fw-600 poppins">{{ __('Sign Up. Earn Points. Get Perks.
                            ') }}</h4>
                        <div class="text-white arial text-15">{{ __("Become trailQuests exclusive member & get access to community deals") }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto">
                <form action="{{route('newsletter.subscribe')}}" class="subcribe-form bravo-subscribe-form bravo-form single-field -w-410 d-flex x-gap-10 y-gap-20">
                    ...
                    <div>
                        ...
                        <div class="form-mess text-gold pt-2"></div>
                    </div>
                    <div>
                        <button class="button -md  fw-600 h-60 {{ $button_classes }}">
                            {{__('SUBSCRIBE')}}  
                        </button>
...
<!-- <script src="https://www.google.com/recaptcha/enterprise.js?render=6LdWQ5kqAAAAAGFeKqskV2awUXAnGCxXs64_6nhL"></script> -->
<script src="{{ asset('libs/jquery-3.6.3.min.js') }}"></script>
<script src="{{ asset('libs/vue/vue'.(!env('APP_DEBUG') ? '.min':'').'.js') }}"></script>
<script type="text/javascript" src="{{asset('themes/yourtrailquest/libs/bs/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{ asset('libs/bootbox/bootbox.min.js') }}"></script>
<script src="{{asset('libs/bootstrap4.0/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('themes/yourtrailquest/js/vendors.js')}}"></script>
<script type="text/javascript" src="{{asset('themes/yourtrailquest/js/main.js?_ver='.config('app.asset_version'))}}"></script>
@if(Auth::id())
...
{{-- home.js --}}
<script src="{{ asset('themes/yourtrailquest/dist/frontend/js/yourtrailquest.js?_ver='.config('app.asset_version')) }}"></script>
