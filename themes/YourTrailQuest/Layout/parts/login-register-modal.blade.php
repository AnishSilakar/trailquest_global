<div class="modal fade login yourtrailquest-login-modal" id="login" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal fade login yourtrailquest-register-modal" id="register" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content relative">
