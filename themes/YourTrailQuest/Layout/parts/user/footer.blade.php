...
<script type="text/javascript" src="{{asset('themes/yourtrailquest/js/main.js')}}"></script>
...
{{-- home.js --}}
<script src="{{ asset('themes/yourtrailquest/dist/frontend/js/yourtrailquest.js?_ver='.config('app.version')) }}"></script>
