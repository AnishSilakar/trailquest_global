...
<div class="d-flex items-center x-gap-80 @if($headerStyle != 'transparent_v4') xl:d-none @endif yourtrailquest-header-{{$headerStyle}}">
    <div class="mr-20">
            ...
            <div class="header-menu__content">
                ...
                <div class="menu js-navList">
                    @php generate_menu('primary',[
                        'walker'=>\Themes\YourTrailQuest\Core\Walkers\MenuWalker::class,
