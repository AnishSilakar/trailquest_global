...
default: $headerClass = '-fixed bg-dark-trailquest';
}
@endphp
...
<header data-add-bg="{{ $dataBg }}" class="header {{ $headerClass }} js-header bravo_header" data-x="header" data-x-toggle="is-menu-opened">
    ...
    <div data-anim="fade" class="{{ $container_class ?? 'header__container' }}   @if($headerStyle == 'transparent_v2') p-3 container @endif is-in-view">
        <div class="row d-flex items-center justify-between pt-4">
            <div class="container @if($headerStyle == 'transparent_v7')  col-left @endif">
                @php
        ...
        <div class="col-auto">
                    ...
                    <div class="header-menu__content">
                        <div class="menu js-navList">
                            <ul class="menu__nav {{$navTextStyle}} -is-active">
                                ...
                                @endif
                                <div class="d-none xl:d-flex x-gap-20 items-center pr-30 text-white" data-x="header-mobile-icons" data-x-toggle="text-white">
                                    <div>
                                        @if(!Auth::check())
            ...
            <div class="d-none xl:d-flex x-gap-20 items-center pr-30 {{$navTextStyle}}" data-x="header-mobile-icons" data-x-toggle="text-white">
