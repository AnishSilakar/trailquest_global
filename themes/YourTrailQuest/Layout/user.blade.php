...
<head>
    ...
    <link href="{{ asset('themes/yourtrailquest/css/vendors.css') }}" rel="stylesheet">
    <link href="{{ asset('themes/yourtrailquest/css/main.css') }}" rel="stylesheet">
    <!-- Fonts -->
    ...
    <link rel="stylesheet" href="{{ asset('themes/yourtrailquest/dist/frontend/css/user.css?_v='.config('app.asset_version')) }}">
    ...
    @if(setting_item_with_lang('enable_rtl'))
        <link href="{{ asset('themes/yourtrailquest/dist/frontend/css/rtl.css') }}" rel="stylesheet">
    @endif
