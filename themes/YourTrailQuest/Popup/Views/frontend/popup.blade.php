...
?>
<div class="modal fade bc_popup yourtrailquest-login-modal" id="login" tabindex="-1"  aria-modal="true" role="dialog" id="bc_popup_{{$popup->id}}" data-days="{{$popup->expired_days}}">
