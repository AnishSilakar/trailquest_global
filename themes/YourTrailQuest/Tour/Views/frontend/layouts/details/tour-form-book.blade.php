...
<div class="bravo_single_book_wrap d-flex justify-end js-pin-content" data-offset="400">
    <div class="w-360 lg:w-full d-flex flex-column items-center">
        <div class="bravo_single_book px-30 py-30 rounded-4 border-light bg-wh shadow-4">
                ...
                <div class="row y-gap-15 items-center justify-between">
                    <div class="col-auto">
                        <div class="text-14 ">
                            ...
                            <span class="text-20 fw-500 text-white">{{ $row->display_price }}</span>
                        </div>
                    </div>
                    <!-- @if($review_score)
                        <div class="col-auto">
                ...
                <div class="form-book">
                    <div class="form-content">
                        <div class="row y-gap-20 pt-20">
                            <div class="col-12">
                                <div class="form-group form-date-field form-date-search clearfix px-20 py-10 bg-ds border-light rounded-4 -right position-relative" data-format="{{get_moment_date_format()}}">
                            ...
                            <div class="col-12" v-for="(type,index) in person_types" v-if="person_types">
                                <div class="searchMenu-guests px-20 py-10 border-light rounded-4 bg-ds js-form-dd" :class="{'d-none':type.max==0}">
                                    <div data-x-dd-click="searchMenu-guests">
                                        <h4 class="text-15 fw-500 ls-2 lh-16">@{{type.name}}</h4>
                                        <h4 class="text-12 fw-400 ls-2 ">@{{type.display_price}} {{__("per person")}}</h4>
                                        ...
                                        <div class="extra-price-wrap d-flex justify-content-between">
                                            <div class="flex-grow-1">
                                                <label class="d-flex items-center">
                                                    <span class="form-checkbox bg-light">
                            ...
                            <div class="col-12" v-if="buyer_fees.length">
                                <div class="form-section-group form-group-padding px-20 py-10 bg-ds border-light rounded-4">
                            ...
                            <div class="col-12">
                                <div class="submit-group">
                                    ...
                                    <a class="button -dark-1 py-15 px-15 text-13 h-60 col-12 rounded-4 bg-bd text-white cursor-pointer" @click="doSubmit($event)" :class="{'disabled':onSubmit,'btn-success':(step == 2),'btn-primary':step == 1}" name="submit">
                                        <span v-if="step == 1">{{__("BOOK MY TREK")}} <br/>{{__("I WANT TO HIT THE TRAILS THIS SPRING")}}</span>
