@if($list_item)
    <section class="layout-pt-lg">
        <div class="layout-pt-lg bg-dark-1  style2">
            <div class="container">

                <div class="row y-gap-60 items-center ">
                    <div class="col-md-5">
                        <h2 class=" text-white">{!! clean($title) !!}</h2>
                                ...
                                @foreach($list_item as $item)
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40 shadow-2">
                                            <div class="">
                                                <h3 class="text-dark-1 mb-20">{{ $item['title'] ?? "" }}</h3>
                                                <p class="testimonials__text lh-18 fw-500 text-dark-1 line-clamp">
                                                    {!! clean($item['desc'] ?? "") !!}
                                                </p>
                                                ...
                                                <div class="pt-20 mt-28 border-top-light">
                                                    <div class="row x-gap-20 y-gap-20 items-center">
                                                        <div class="col-auto">
                                                            <div class="testinomialimage-trailquest">
                                                                <img src="#" data-src="{{ $avatar_url }}"
                                                                    alt="{{ $item['name'] ?? ""}}" class="js-lazy "
