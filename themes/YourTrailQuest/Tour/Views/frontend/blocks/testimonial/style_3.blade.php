@if(!empty($list_item))
<section class="section-bg layout-pt-lg ">
    ...
    <div data-anim-wrap class="container">
        ...
        <div class="relative mt-80 md:mt-40 js-section-slider" data-gap="30" data-slider-cols="xl-3 lg-3 md-2 sm-1 base-1">
            <div class="swiper-wrapper">
                ...
                @foreach($list_item as $item)
                    <div data-anim-child="slide-up delay-{{$i}}" class="swiper-slide">
                        <div class="testimonials -type-1 rounded-4 pt-40 pb-30 px-40  bg-light-2">
                            <h4 class="text-16 fw-500 text-datk-1 mb-20">{{$item['title']}}</h4>
            ...
            <button class="section-slider-nav -prev flex-center button -blue-1 bg-gold shadow-1 size-40 rounded-full sm:d-none js-prev">
                <i class="icon icon-chevron-left text-12 text-white"></i>
            </button>

            <button class="section-slider-nav -next flex-center button -blue-1 bg-gold shadow-1 size-40 rounded-full sm:d-none js-next">
                <i class="icon icon-chevron-right text-12 text-white"></i>
            </button>
