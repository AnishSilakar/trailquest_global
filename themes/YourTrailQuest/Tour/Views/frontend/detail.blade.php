...
@push('css')
<link
    href="{{ asset('themes/yourtrailquest/dist/frontend/module/tour/css/tour.css?_ver='.config('app.asset_version')) }}"
    rel="stylesheet">
...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('themes/yourtrailquest/module/tour/js/single-tour.js?_ver='.config('app.asset_version')) }}"></script>
