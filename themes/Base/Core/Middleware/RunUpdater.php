...
<a href="mailto:contact@sarbatra.com">contact@sarbatra.com</a>',
                    'group' => "general",
                ]
            );
        }
            ...
            DB::table('core_settings')->insert(
                [
                    ...
                    'val'   => '<h1 style="text-align: center;">Welcome!</h1>
                        ...
                        <p>Thank you for signing up with Sarbatra TravelCms! We hope you enjoy your time with us.</p>
                        <p>Regards,</p>
                        <p>Sarbatra TravelCms</p>',
                    'group' => 'vendor'
                ]
            );
        }
