...
function compressPackage() {
	return gulp.src([
		'../builds/sarbatra-core/**',
		'../builds/sarbatra-core/**/.**',
	])
		.pipe(zip('sarbatra-core.zip'))
		.pipe(gulp.dest('../builds/'));

}
function copyPackage() {
	//del('../builds/sarbatra-core/*/**',{force:true});
	...
	return gulp.src([
		...
		.pipe(gulp.dest('../builds/sarbatra-core'));
}
function makeEnv() {
	return gulp.src([
		'.env.example',
...
function cleanBuildFolder(){
	return gulp.src('../builds/sarbatra-core', {read: false, allowEmpty: true })
